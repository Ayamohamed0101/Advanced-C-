...
public:
	...
	//static vector <stLoginRegisterRecord> getUserList()
	//{
	...
	//		while (getline(myfile, line))
	//		{
	//			registerlogin= _ConvertLoginRegisterLineToRecord(line);
	//			vuser.push_back(registerlogin);
	//		}
	//		myfile.close();
	//	}	
	//	return vuser;
