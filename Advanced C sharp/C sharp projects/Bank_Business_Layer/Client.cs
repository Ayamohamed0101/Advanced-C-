...
namespace Bank_Business_Layer
{
    ...
    public class clsClient : clsPerson
    {
        ...
        private clsClient(int Client_ID, int Person_ID, string AccountNumber, string FirstName,string LastName,
            string Country,string City,string Street, string Email, string PinCode, string Phone, double Balance) : base(Person_ID,FirstName,LastName,Country,City,Street)
        { 
